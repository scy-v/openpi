...
class Recorder:
    ...
    def save_videos_multi_codec(self):
        ...
        print("\n🔧 Saving right wrist camera videos...")
        for vcodec, crf, preset in codecs:
            out_path = self.right_wrist_video.parent   / f"right_wrist_{vcodec}.mp4"
            _encode(self.frames_right_wrist, out_path, vcodec=vcodec, crf=crf, preset=preset)
